        ...
        <div className="mnmd-block mnmd-block--fullwidth featured-module-2">
            <div className="mnmd-block__inner">
                ...
                <div id="js-active-tabs" className="tab text-center">
                    <button
                        className="btn-default tab-links is-active"
                        onClick={handleShowAllClick}
                    >
                        All
                    </button>
                    <button className="btn-default tab-links" onClick={handleShowNewClick}>
                        coffee
                    </button>
                    <button className="btn-default tab-links" onClick={handleShowOldClick}>
                        street food
                    </button>
                </div>
